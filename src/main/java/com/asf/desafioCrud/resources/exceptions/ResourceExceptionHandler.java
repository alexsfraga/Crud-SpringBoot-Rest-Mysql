package com.asf.desafioCrud.resources.exceptions;
...
import com.asf.desafioCrud.service.exceptions.ObjectNotFoundException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request ){
		StandardError err = new StandardError(HttpStatus.NOT_FOUND.value(), 
				 "StackTrace=" + e.getStackTrace() + " -- LocalizedMessage="+e.getLocalizedMessage() + " -- Message=" +  e.getMessage(), 
